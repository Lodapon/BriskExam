    ...
    <div class="iq-navbar-custom">
       <nav class="navbar navbar-expand-lg navbar-light p-0">
        <a href="/" class="navbar-brand logo">
          ...
          <a class="nav-link navbar-list-std iq-waves-effect" href="{{route('std.db')}}">Dashboard <span class="sr-only">(current)</span></a>

          <a class="nav-link navbar-list-std iq-waves-effect" href="/std/addCredit">Add Credit</a>

          <div class="dropdown">
            <button class="dropbtn">Test</button>
            <div class="dropdown-content">
              <a class="nav-link  iq-waves-effect" href="{{route('std.fixlist')}}">Fix Exam</a>
              <a class="nav-link  iq-waves-effect" href="{{route('std.mocklist')}}">Mockup</a>
            </div>
          </div>

          <a class="nav-link navbar-list-std iq-waves-effect" href="/std/bookshop">Book shop</a>

          <a class="nav-link navbar-list-std iq-waves-effect" href="/std/edit">Edit Profile</a>

          <a class="nav-link navbar-list-std iq-waves-effect" href="/logout">Log Out</a>
...
<style>
  .navbar-list-std {font-size: 18px;}
