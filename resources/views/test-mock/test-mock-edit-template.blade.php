...
$(document).ready(function() {
  ...
  function loadSubjects(){
    ...
    function saveTemplate() {
        ...
        formData.append("meId", window.location.pathname.split("/").pop());
              ...
              <div class="iq-card">
                <div class="iq-card-header d-flex justify-content-between">
                    <div class="iq-header-title">
                        <h4 class="card-title">แก้ไข Template ข้อสอบ Mockup</h4>
                    </div>
                </div>
                        ...
                        @foreach ($secs as $item)
                          <div class="form-group row">
                              <div class="col-lg-4">
                                ...
                                @endif
                                <input type="text" id='numProbC{{ $loop->iteration }}' class="form-control" placeholder="จำนวนข้อสอบตัวเลือก" value="{{$item->me_choice_total}}">
                              </div>
                              <div class="col-lg-4">
                                @if ($loop->first)
                                <label>จำนวนตัวเลือก</label>
                                @endif
                                <input type="text" id='numC{{ $loop->iteration }}' class="form-control" placeholder="จำนวนตัวเลือก" value="{{$item->me_choice}}">
                              </div>
                              <div class="col-lg-4">
                                @if ($loop->first)
                                <label>จำนวนข้อสอบเติมคำ</label>
                                @endif
                                <input type="text" id='numProbD{{ $loop->iteration }}' class="form-control" placeholder="จำนวนข้อสอบเติมคำ" value="{{$item->me_write}}">
                              </div>
                          </div>
                          @endforeach
                        </div>
                  ...
                  <div class="card-body text-primary">
                      <div id="tagPanel">
                        ...
                        <div class="form-row" >
                            ...
                            <div class="col-lg-11">
                                <input type="text" list="datalistOptions" id="tag{{ $loop->iteration }}" data-role="tagsinput" class="form-control texttag" placeholder="tags" value="{{$tag->me_tags}}">
                                <br>
                            </div>
                        </div>
                        @if ($loop->last)
