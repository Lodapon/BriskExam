                            ...
                            <div class="iq-card-body">
                                    ...
                                    <div class="iq-card">
                                        <div class="iq-card-header d-flex">
                                           <div class="iq-header-title">
                                              <h5 class="card-title">  <div class="row">{{ $loop->iteration }}) {!!$mock!!}</div></h5>
                                           </div>
                                        </div>
                                        <div class="iq-card-body">
                                                ...
                                                @foreach($exam as $ans)
                                                    {{-- <div class="row"> --}}
                                                        <div class="col-md-12">
                                                                ...
                                                                @else
                                                                <div class="row alert @foreach($anws as $item) @if($item->me_det_id == $ans->me_det_id) @if($item->me_ans_no == $ans->me_ans_no)alert-danger @endif @endif @endforeach">{{ $loop->iteration }}) {!! $ans->me_ans !!}</div>
                                                                @endif
                                                        </div>
                                                        @if ($loop->last)
