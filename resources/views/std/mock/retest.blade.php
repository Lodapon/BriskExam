                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" class="custom-control-input" id="{{ $ans->me_det_id }}_{{ $ans->me_ans_no }}" name="answer{{$ans->me_det_id}}"
                                                        @foreach($anws as $item)
                                                            @if($item->me_det_id == $ans->me_det_id)
                                                                @if($item->me_ans_no == $ans->me_ans_no)
                                                                checked
                                                                @endif
                                                            @endif
                                                        @endforeach
                                                        value="{{ $ans->me_det_id }}_{{ $ans->me_ans_no }}"/>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="custom-control">
                                                        @foreach($anws as $item)
                                                            @if($item->me_det_id == $ans->me_det_id)
                                                                <input type="text" style="margin-bottom: 10px" class="form-control" id="{{ $ans->me_det_id }}_{{ $ans->me_ans_no }}" name="answer{{$ans->me_det_id}}" value="{{$item->me_ans_no}}">
                                                            @endif
                                                        @endforeach
                                                    </div>
                                                </div>
